...
const method = "post";
export default {
	sp_admin_retrieve_site_info({ state, rootState, siteId }) {
    const userId = rootState.auth.userId;
    const url = "api/admin/1_03_main/sp_admin_retrieve_site_info";
    const data = {
  ...
  sp_admin_update_site_info({ state, rootState }) {
    const userId = rootState.auth.userId;
    const method = "post";
    const url = "api/admin/1_03_main/sp_admin_update_site_info";
    const data = {
